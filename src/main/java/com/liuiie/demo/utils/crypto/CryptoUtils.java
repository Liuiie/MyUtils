...
public class CryptoUtils {
    ...
    public static class Algorithm {
        ...
        public boolean equals(Object o) {
            ...
            return keySize == algorithm.keySize && Objects.equals(name, algorithm.name) && Objects.equals(transformation, algorithm.transformation);
        }

        @Override
        public int hashCode() {
            return Objects.hash(name, transformation, keySize);
        }
    }
